...
@Component({
  ...
  styleUrls: ['./query-app.component.scss']
})
...
objectKeys = Object.keys;
  constructor(public commonService:CommonService,public service: PredictorService, private compound: Compound, private toastr: ToastrService) { }
