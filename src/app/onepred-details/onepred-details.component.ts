...
@Component({
  selector: 'app-onepred-details',
  templateUrl: './onepred-details.component.html',
  styleUrls: ['./onepred-details.component.scss']
})
export class OnepredDetailsComponent implements OnChanges {
  ...
  constructor(public prediction: Prediction,public model: Model, public global: Globals) { }
